...
class SystemInfo {
    ...
    static func getDeviceName() -> String {
        ...
        let versionString = "\(deviceModel) (iOS \(deviceOSVersion))"
        return versionString
    }
}

// Based on https://stackoverflow.com/a/46234519
// This has to be updated with each new device release
...
public extension UIDevice {
    ...
    var type: DeviceModel {
        ...
        guard let map = modelCode, let model = modelMap[map] else { return DeviceModel.unrecognized }
        if model == .simulator {
