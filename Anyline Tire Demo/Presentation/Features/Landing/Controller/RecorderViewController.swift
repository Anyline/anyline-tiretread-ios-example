...
class RecorderViewController: UIViewController {
    ...
    private func sendTireIdFeedback(uuid: String, tireId: String, qrViewController: QRCodeReaderViewController) {
        var alertTitle = "recorder.alert.title".localized()
        var alertMessage = "recorder.alert.message_success".localized()
        var actions: [UIAlertAction] = []

        AnylineTireTreadSdk.companion.sendTireIdFeedback(measurementUuid: uuid, tireId: tireId) { [weak self] in
            ...
            alertTitle = "recorder.alert.title".localized()
            alertMessage = "recorder.alert.message_failure".localized()
